...
const resetPassword = async (req, res = response) => {
    ...
    try {
      ...
      const transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
          user: 'terrenoscve@gmail.com',
          pass: 'ubvddnvviaptdpkh',
          // pass: 'dr.valencia',
        },
      });
  
      const mailOptions = {
        from: 'terrenoscve@gmail.com',
        to: email,
        subject: 'Restablecimiento de Contraseña',
        html: `
          <p>Has solicitado restablecer tu contraseña.</p>
          <p>Por favor, haz clic en el siguiente enlace para continuar:</p>
          <a href="http://localhost:65355/#/auth/ressetPasswordP/?token=${token}">Restablecer Contraseña</a>
        `,
      };
